...
public class mudcrack extends PApplet {
...
class Patch {
  ...
  public Patch oneOfNeighbor4() {
    return neighbor4(PApplet.parseInt(random(4)));
  }
  public Patch oneOfNeighbor8() {
    return neighbor8(PApplet.parseInt(random(8)));
  }
...
class PatchGrid {
  ...
  public Patch randomPatch() {
    return patch(PApplet.parseInt(random(area)));
  }
...
public void draw() {
  int start = millis();
  int end = start + PApplet.parseInt((1000.0f / iframerate) * 0.9f);
  int steps = 0;
  while (millis() < end) {
    grid.simulate();
    steps += 1;
...
public void setParam(String name, String value) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#c4c4c4", "mudcrack" });
  }
}
