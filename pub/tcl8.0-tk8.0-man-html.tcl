...
proc parse_command_line {} {
    ...
    set tcltkdir /packages
    set tkdir {}
    set tcldir {}
    set webdir /packages/www.elf.org/tcl8.0-tk8.0-man-html

    # Directory names for Tcl and Tk, in priority order.
    set tclDirList {tcl8.0 tcl tcl7.4 tcl7.5 tcl7.6}
    set tkDirList {tk8.0 tk tk4.0 tk4.1 tk4.2}
