##
## load xpm format data into a photo image
##
## Copyright 1996 by Roger E. Critchlow Jr., San Francisco, California
## All rights reserved, fair use permitted, caveat emptor.
## rec@elf.org
##
## $file is a name used to tag error messages, the name of the file
## from which data was read is a good choice.
## $string is the data defining the pixmap, the literal contents of
## an xpm file.
## $image, if provided, is the name of the image photo into which the
## pixmap should be loaded.
##
## xpm-to-image returns the name of the image into which the pixmap was
## loaded.
##
proc xpm-to-image {file string {image {}}} {
    #
    # create image name if necessary
    #
    if {"$image" == {}} {
    ...
    #
    image create photo $image -width $data(width) -height $data(height);
    set y 0;
